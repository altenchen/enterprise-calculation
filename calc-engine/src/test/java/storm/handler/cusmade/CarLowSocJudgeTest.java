...
class CarLowSocJudgeTest {
    ...
    void testProcessFrame() {
        ...
        String result_1 = carLowSocJudge.processFrame(TEST_VID, ImmutableMap.copyOf(data));
        ...
        String result_2 = carLowSocJudge.processFrame(TEST_VID, ImmutableMap.copyOf(data));
        ...
        String result_3 = carLowSocJudge.processFrame(TEST_VID, ImmutableMap.copyOf(data));
        ...
        String result_4 = carLowSocJudge.processFrame(TEST_VID, ImmutableMap.copyOf(data));
        ...
        String result_5 = carLowSocJudge.processFrame(TEST_VID, ImmutableMap.copyOf(data));
