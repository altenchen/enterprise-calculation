...
class CarHighSocJudgeTest {
    ...
    void testProcessFrame() {
        ...
        Map<String, String> result_1 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        Assertions.assertTrue(MapUtils.isEmpty(result_1), "第1帧不该出现故障通知");
        ...
        Map<String, String> result_2 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        Assertions.assertTrue(MapUtils.isEmpty(result_2), "第2帧不该出现故障通知");
        ...
        Map<String, String> result_3 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        Assertions.assertTrue(MapUtils.isNotEmpty(result_3), "第3帧出现故障通知");
        ...
        Map<String, String> result_4 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        Assertions.assertTrue(MapUtils.isEmpty(result_4), "第4帧不应该故障结束");
        ...
        Map<String, String> result_5 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        Assertions.assertTrue(MapUtils.isNotEmpty(result_5), "第5帧故障结束");
