...
class CarHighSocJudgeTest {
    ...
    void testProcessFrame() {
        ...
        List<Map<String, Object>> result_1 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        ...
        List<Map<String, Object>> result_2 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        ...
        List<Map<String, Object>> result_3 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        ...
        List<Map<String, Object>> result_4 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
        ...
        List<Map<String, Object>> result_5 = carHighSocJudge.processFrame(ImmutableMap.copyOf(data));
