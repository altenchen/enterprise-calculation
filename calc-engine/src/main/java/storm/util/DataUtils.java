...
public final class DataUtils {
     ...
     * @return 是否为自动唤醒报文
     */
    public static boolean judgeAutoWake(@NotNull Map<String,String> data){
        String totalVoltage = data.get(DataKey._2613_TOTAL_VOLTAGE);
        String totalElectricity = data.get(DataKey._2614_TOTAL_ELECTRICITY);
