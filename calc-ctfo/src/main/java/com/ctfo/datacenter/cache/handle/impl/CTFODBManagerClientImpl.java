...
public class CTFODBManagerClientImpl
    ...
    protected CTFODBManagerClientImpl() {
    }

    public CTFODBManagerClientImpl(String address, ConnConfig connConfig)
    ...
    public ShardControl getShardControl() {
        if (!"0".equals(PubSubManager.getShardStatus(this.address))) {
            return this.addShardControl;
        }
        return this.shardControl;
    }
